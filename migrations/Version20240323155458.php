 ...
 */
final class Version20240323155458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE pre_registration_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE pre_registration_id_seq CASCADE');
