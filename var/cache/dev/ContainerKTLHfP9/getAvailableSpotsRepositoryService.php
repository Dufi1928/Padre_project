 ...
 */
class getAvailableSpotsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AvailableSpotsRepository' shared autowired service.
     *
     * @return \App\Repository\AvailableSpotsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AvailableSpotsRepository.php';

        return $container->privates['App\\Repository\\AvailableSpotsRepository'] = new \App\Repository\AvailableSpotsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
